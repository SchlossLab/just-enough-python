...
The biggest difference between R and Python: no dots are allowed in Python 
variable names. All other rules from R apply. Python variable names must start 
...
1. Bonus: use `expand()` to get a list of figures for the paper in `render_paper`.
